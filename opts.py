...
class opts():
    ...
    def init(self):
        ...
        self.parser.add_argument('-category', default='cifar', help='training category')
        ...
        self.parser.add_argument('-set', default='cifar', help='which dataset, scene/cifar')
        ...
        self.parser.add_argument('-sigma_gen', type=float, default=0.3,help='')
        self.parser.add_argument('-langevin_step_num_gen', type=int, default=0, help='# hourglasses to stack')
        self.parser.add_argument('-langevin_step_size_gen', type=float, default=0.1, help='# hourglasses to stack')
        ...
        self.parser.add_argument('-langevin_step_num_des', type=int, default=10, help='drop LR')
        self.parser.add_argument('-langevin_step_size_des', type=float, default=0.002, help='# hourglasses to stack')
